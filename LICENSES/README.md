# Licenses in the Spyderisk Adaptor and how to apply them
...
We currently use these licenses in the Spyderisk Adaptor:
...
you are reading, because they are covered by other statements.  Similarly we do
not add copyright headers to images, we just make a statement in a file
covering all the images. However most non-Markdown forms of documentation do
have explicit CC BY-SA license at the top.
...
* other GPL licenses are compatible but for the Adaptor project its likely more hassle than its worth.
