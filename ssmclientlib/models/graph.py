...
class Graph(BaseModel):
    ...
    Graph
    """ # noqa: E501
    threats: Optional[Dict[str, StrictInt]] = None
    misbehaviours: Optional[Dict[str, StrictInt]] = None
    twas: Optional[Dict[str, StrictInt]] = None
    links: Optional[List[List[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["threats", "misbehaviours", "twas", "links"]
