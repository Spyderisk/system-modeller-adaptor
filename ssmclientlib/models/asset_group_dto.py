...
class AssetGroupDTO(BaseModel):
    ...
    asset_ids: Optional[List[Dict[str, Any]]] = Field(default=None, alias="assetIds")
    name: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["uri", "label", "description", "left", "top", "width", "height", "expanded", "assetIds", "name", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetGroupDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetGroupDTO from a dict"""
        if obj is None:
            return None
