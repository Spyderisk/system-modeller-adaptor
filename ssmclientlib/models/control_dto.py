...
class ControlDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["label", "description", "uri", "asset", "action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControlDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControlDTO from a dict"""
        if obj is None:
            return None
