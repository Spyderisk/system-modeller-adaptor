...
class JobResponseDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["jobId", "state", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobResponseDTO from a dict"""
        if obj is None:
            return None
