...
class ModelDB(BaseModel):
    ...
    risks_valid: Optional[StrictBool] = Field(default=None, alias="risksValid")
    risk_calculation_mode: Optional[StrictStr] = Field(default=None, alias="riskCalculationMode")
    version_info: Optional[StrictStr] = Field(default=None, alias="versionInfo")
    ...
    __properties: ClassVar[List[str]] = ["uri", "type", "id", "label", "description", "risk", "risksValid", "riskCalculationMode", "versionInfo", "domainVersion", "created", "modified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelDB from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelDB from a dict"""
        if obj is None:
            return None
