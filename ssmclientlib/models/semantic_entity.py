...
class SemanticEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "label", "description", "parents", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SemanticEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SemanticEntity from a dict"""
        if obj is None:
            return None
