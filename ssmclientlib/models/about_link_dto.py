...
class AboutLinkDTO(BaseModel):
    """
    AboutLinkDTO
    """ # noqa: E501
    link: Optional[StrictStr] = None
    text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["link", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AboutLinkDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AboutLinkDTO from a dict"""
        if obj is None:
            return None
