...
class RecommendationReportDTO(BaseModel):
    ...
    """ # noqa: E501
    current: Optional[StateDTO] = None
    recommendations: Optional[List[RecommendationDTO]] = None
    __properties: ClassVar[List[str]] = ["current", "recommendations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecommendationReportDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecommendationReportDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "current": StateDTO.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "recommendations": [RecommendationDTO.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None
        })
        return _obj
