...
class AssetDB(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "type", "id", "label", "description", "asserted", "minCardinality", "maxCardinality", "population"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetDB from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetDB from a dict"""
        if obj is None:
            return None
