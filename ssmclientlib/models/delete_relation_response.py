...
class DeleteRelationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["relations", "valid", "empty"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteRelationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteRelationResponse from a dict"""
        if obj is None:
            return None
