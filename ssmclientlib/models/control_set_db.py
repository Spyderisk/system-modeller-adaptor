...
class ControlSetDB(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uri", "type", "id", "locatedAt", "control", "proposed", "coverageLevel", "minOf", "maxOf", "hasMin", "hasMax"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControlSetDB from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControlSetDB from a dict"""
        if obj is None:
            return None
