...
async def notify_natool_report(
    ...
    try:
        ...
        #TODO parse NATool report and convert it to intenal state report ...

        state_report_message = await bg_process_natool_report(model_webkey, natool_report, ssm_client, db_client)
